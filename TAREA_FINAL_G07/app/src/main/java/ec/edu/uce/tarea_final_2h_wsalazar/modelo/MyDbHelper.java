package ec.edu.uce.tarea_final_2h_wsalazar.modelo;
...
public class MyDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.PLACA, "QWE-6784");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.MARCA, "Nissan");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.FECFAB, "2015-01-01");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.COSTO, 30000.0);
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.MATRICULADO, 0);
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.COLOR, "Negro");
        ...
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.PLACA, "ASD-9999");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.MARCA, "Lada");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.FECFAB, "2014-01-01");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.COSTO, 12200.0);
        ...
        values = new ContentValues();
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.PLACA, "FGH-5555");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.MARCA, "Chevrolet");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.FECFAB, "2014-01-01");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.COSTO, 12000.0);
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.MATRICULADO, 1);
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.COLOR, "Otro");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.FOTO, getStringFromBitmap(((BitmapDrawable)drawable).getBitmap()));
        ...
        drawable = ContextCompat.getDrawable(contxt, R.drawable.auto2);
        values = new ContentValues();
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.PLACA, "UIO-1111");
        ...
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.COSTO, 19000.0);
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.MATRICULADO, 1);
        ...
        drawable = ContextCompat.getDrawable(contxt, R.drawable.auto2);
        values = new ContentValues();
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.PLACA, "BNM-3333");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.MARCA, "Ford");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.FECFAB, "2017-01-01");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.COSTO, 22000.0);
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.MATRICULADO, 1);
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.COLOR, "Otro");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.FOTO, getStringFromBitmap(((BitmapDrawable)drawable).getBitmap()));
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.ESTADO, 0);
        ...
        drawable = ContextCompat.getDrawable(contxt, R.drawable.icon);
        values = new ContentValues();
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.PLACA, "WWE-6666");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.MARCA, "Chevrolet");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.FECFAB, "2017-01-01");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.COSTO, 17000.0);
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.MATRICULADO, 0);
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.COLOR, "Negro");
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.FOTO, getStringFromBitmap(((BitmapDrawable)drawable).getBitmap()));
        values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.ESTADO, 1);
        ...
        db.execSQL(insert);
        insert = "INSERT INTO "+EsquemaUsuario.ColumnasUsuario.TABLE_NAME+" ("+EsquemaUsuario.ColumnasUsuario.NAME+", "+EsquemaUsuario.ColumnasUsuario.PASS+") VALUES (\"dscumbajin\",\"dscumbajin\");";
        db.execSQL(insert);
        insert = "INSERT INTO "+EsquemaUsuario.ColumnasUsuario.TABLE_NAME+" ("+EsquemaUsuario.ColumnasUsuario.NAME+", "+EsquemaUsuario.ColumnasUsuario.PASS+") VALUES (\"avelez\",\"avelez\");";
        db.execSQL(insert);
        insert = "INSERT INTO "+EsquemaUsuario.ColumnasUsuario.TABLE_NAME+" ("+EsquemaUsuario.ColumnasUsuario.NAME+", "+EsquemaUsuario.ColumnasUsuario.PASS+") VALUES (\"wsalazar\",\"wsalazar\");";
        db.execSQL(insert);
        insert = "INSERT INTO "+EsquemaUsuario.ColumnasUsuario.TABLE_NAME+" ("+EsquemaUsuario.ColumnasUsuario.NAME+", "+EsquemaUsuario.ColumnasUsuario.PASS+") VALUES (\"root\",\"root\");";
        db.execSQL(insert);
