...
import ec.edu.uce.tarea_final_2h_wsalazar.controlador.ReservaControl;
import ec.edu.uce.tarea_final_2h_wsalazar.modelo.Globales;
import ec.edu.uce.tarea_final_2h_wsalazar.modelo.InterfazCRUD;
import ec.edu.uce.tarea_final_2h_wsalazar.modelo.MailJob;
import ec.edu.uce.tarea_final_2h_wsalazar.modelo.MyDbHelper;
import ec.edu.uce.tarea_final_2h_wsalazar.modelo.Reserva;
import ec.edu.uce.tarea_final_2h_wsalazar.modelo.Usuario;
...
public class ReservarActivity extends AppCompatActivity implements InterfazCRUD {
    ...
    public void listarReservas(View view) {
        ...
        intent.putExtra("titulo", "LISTA DE AUTOS RESERVADOS");
